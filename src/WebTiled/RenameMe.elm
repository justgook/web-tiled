...
shortcuts =
    Dict.fromList
        ...
        , ( "Show Properties", { msg = ShowProperties, shortcut = "" } )
        , ( "Show Layers", { msg = ShowLayers, shortcut = "" } )
        , ( "Show Tilesets", { msg = ShowTilesets, shortcut = "" } )
        , ( "Show FileManager", { msg = ShowFileManager, shortcut = "" } )
        , ( "Show Toolbar", { msg = ShowToolbar, shortcut = "" } )
        , ( "Show StatusBar", { msg = ShowStatusBar, shortcut = "" } )
        ...
        , ( "Map Properties", { msg = MapProperties, shortcut = "" } )
        ...
        , ( "Layer Properties", { msg = LayerProperties, shortcut = "" } )
        ]
